...
Make sure the podcast artwork has the naming convention `[data_dir]/[podcast_id]/[podcast_id].jpg`.  
...
- Get a cookies.txt file (Netscape cookies format) from my browser, and configure the youtube_dl_args to use it.  
